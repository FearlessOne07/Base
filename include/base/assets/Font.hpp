...
namespace Base
{
  ...
  public:
    ...
    static Vector2 MeasureText(const Ptr<Font> &font, const std::wstring_view string, float fontSize);
    static Vector2 MeasureText(const Ptr<Font> &font, const std::string_view text, float fontSize);
